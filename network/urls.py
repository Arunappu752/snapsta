...
urlpatterns = [
    ...
    path('n/editprofile/', views.edit_profile,name='editprofile'),
    path('n/following/<str:username>', views.following_list, name='following_list'),
    path('n/followers/<str:username>', views.followers_list, name='followers_list'),
